...
public class TestPlanListAllOf {
  public static final String SERIALIZED_NAME_VALUES = "values";
  @SerializedName(SERIALIZED_NAME_VALUES)
  private List<TestPlan> values = null;

  public TestPlanListAllOf() { 
  }

  public TestPlanListAllOf values(List<TestPlan> values) {
    
    this.values = values;
    return this;
  }

  public TestPlanListAllOf addValuesItem(TestPlan valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TestPlanListAllOf testPlanListAllOf = (TestPlanListAllOf) o;
    return Objects.equals(this.values, testPlanListAllOf.values);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestPlanListAllOf {\n");

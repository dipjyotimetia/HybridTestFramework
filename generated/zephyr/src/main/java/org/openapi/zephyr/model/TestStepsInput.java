 ...
 */
@ApiModel(description = "Request body for creating test steps. A maximum of 100 test steps can be added in one request. To add more than 100 steps, you can submit multiple requests. The mode property allows you to specify whether you want to delete the current test steps and create a new list, or append more items to the end of the current list.")
...
public class TestStepsInput {
  ...
  public TestStepsInput() { 
  }

  public TestStepsInput mode(String mode) {
   ...
   /**
   * Valid values: &#x60;\&quot;APPEND\&quot;&#x60;, &#x60;\&quot;OVERWRITE\&quot;&#x60;
   * @return mode
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Valid values: `\"APPEND\"`, `\"OVERWRITE\"`")
  ...
  public TestStepsInput items(List<TestStep> items) {
    
    this.items = items;
    return this;
  }

  public TestStepsInput addItemsItem(TestStep itemsItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The list of test steps")

  public List<TestStep> getItems() {
    return items;
  }


  public void setItems(List<TestStep> items) {
    this.items = items;
  }
  ...
  public boolean equals(Object o) {
    ...
    TestStepsInput testStepsInput = (TestStepsInput) o;
    return Objects.equals(this.mode, testStepsInput.mode) &&
        Objects.equals(this.items, testStepsInput.items);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestStepsInput {\n");

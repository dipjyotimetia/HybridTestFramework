...
public class ProjectListAllOf {
  public static final String SERIALIZED_NAME_VALUES = "values";
  @SerializedName(SERIALIZED_NAME_VALUES)
  private List<Project> values = null;

  public ProjectListAllOf() { 
  }

  public ProjectListAllOf values(List<Project> values) {
    
    this.values = values;
    return this;
  }

  public ProjectListAllOf addValuesItem(Project valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ProjectListAllOf projectListAllOf = (ProjectListAllOf) o;
    return Objects.equals(this.values, projectListAllOf.values);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProjectListAllOf {\n");

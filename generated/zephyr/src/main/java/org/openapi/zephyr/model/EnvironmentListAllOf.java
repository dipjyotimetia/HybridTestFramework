...
public class EnvironmentListAllOf {
  public static final String SERIALIZED_NAME_VALUES = "values";
  @SerializedName(SERIALIZED_NAME_VALUES)
  private List<Environment> values = null;

  public EnvironmentListAllOf() { 
  }

  public EnvironmentListAllOf values(List<Environment> values) {
    
    this.values = values;
    return this;
  }

  public EnvironmentListAllOf addValuesItem(Environment valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    EnvironmentListAllOf environmentListAllOf = (EnvironmentListAllOf) o;
    return Objects.equals(this.values, environmentListAllOf.values);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnvironmentListAllOf {\n");

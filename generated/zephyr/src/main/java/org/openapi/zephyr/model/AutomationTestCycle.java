...
public class AutomationTestCycle {
  ...
  public AutomationTestCycle() { 
  }

  public AutomationTestCycle id(Long id) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The id of the newly created test cycle.")
  ...
  public AutomationTestCycle url(String url) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The URL pointing to the newly created test cycle.")
  ...
  public AutomationTestCycle key(String key) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The key of the newly created test cycle.")
  ...
  public boolean equals(Object o) {
    ...
    AutomationTestCycle automationTestCycle = (AutomationTestCycle) o;
    return Objects.equals(this.id, automationTestCycle.id) &&
        Objects.equals(this.url, automationTestCycle.url) &&
        Objects.equals(this.key, automationTestCycle.key);
  }
  ...
  public String toString() {
    ...
    sb.append("class AutomationTestCycle {\n");

...
import org.openapi.zephyr.model.TestStepInline;
import org.openapi.zephyr.model.TestStepTestCase;
 ...
 */
@ApiModel(description = "An instruction to be followed as part of a step-by-step test script. The test step can have either an inline definition, or delegate execution to another test case. One of these options must be specified.")
...
public class TestStep {
  ...
  private TestStepInline inline;

  public static final String SERIALIZED_NAME_TEST_CASE = "testCase";
  @SerializedName(SERIALIZED_NAME_TEST_CASE)
  private TestStepTestCase testCase;

  public TestStep() { 
  }

  public TestStep inline(TestStepInline inline) {
  ...
  **/
  ...
  public TestStepInline getInline() {
    return inline;
  }


  public void setInline(TestStepInline inline) {
    this.inline = inline;
  }


  public TestStep testCase(TestStepTestCase testCase) {
  ...
  **/
  ...
  public TestStepTestCase getTestCase() {
    return testCase;
  }


  public void setTestCase(TestStepTestCase testCase) {
    this.testCase = testCase;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.inline, testStep.inline) &&
        Objects.equals(this.testCase, testStep.testCase);
  }

  @Override
  public int hashCode() {
    return Objects.hash(inline, testCase);
  }

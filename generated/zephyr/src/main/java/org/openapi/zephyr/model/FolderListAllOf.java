...
public class FolderListAllOf {
  public static final String SERIALIZED_NAME_VALUES = "values";
  @SerializedName(SERIALIZED_NAME_VALUES)
  private List<Folder> values = null;

  public FolderListAllOf() { 
  }

  public FolderListAllOf values(List<Folder> values) {
    
    this.values = values;
    return this;
  }

  public FolderListAllOf addValuesItem(Folder valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FolderListAllOf folderListAllOf = (FolderListAllOf) o;
    return Objects.equals(this.values, folderListAllOf.values);
  }
  ...
  public String toString() {
    ...
    sb.append("class FolderListAllOf {\n");

...
public class TestCaseVersionLinkListAllOf {
  public static final String SERIALIZED_NAME_VALUES = "values";
  @SerializedName(SERIALIZED_NAME_VALUES)
  private List<TestCaseVersionLink> values = null;

  public TestCaseVersionLinkListAllOf() { 
  }

  public TestCaseVersionLinkListAllOf values(List<TestCaseVersionLink> values) {
    
    this.values = values;
    return this;
  }

  public TestCaseVersionLinkListAllOf addValuesItem(TestCaseVersionLink valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TestCaseVersionLinkListAllOf testCaseVersionLinkListAllOf = (TestCaseVersionLinkListAllOf) o;
    return Objects.equals(this.values, testCaseVersionLinkListAllOf.values);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestCaseVersionLinkListAllOf {\n");

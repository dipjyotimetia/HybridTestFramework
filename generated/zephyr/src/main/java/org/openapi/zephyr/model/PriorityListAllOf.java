...
public class PriorityListAllOf {
  public static final String SERIALIZED_NAME_VALUES = "values";
  @SerializedName(SERIALIZED_NAME_VALUES)
  private List<Priority> values = null;

  public PriorityListAllOf() { 
  }

  public PriorityListAllOf values(List<Priority> values) {
    
    this.values = values;
    return this;
  }

  public PriorityListAllOf addValuesItem(Priority valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    PriorityListAllOf priorityListAllOf = (PriorityListAllOf) o;
    return Objects.equals(this.values, priorityListAllOf.values);
  }
  ...
  public String toString() {
    ...
    sb.append("class PriorityListAllOf {\n");

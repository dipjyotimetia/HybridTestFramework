...
import org.openapi.zephyr.model.TestCaseVersionLinkListAllOf;
...
public class TestCaseVersionLinkList {
  ...
  private List<TestCaseVersionLink> values = null;

  public TestCaseVersionLinkList() { 
  }

  public TestCaseVersionLinkList next(String next) {
  ...
  **/
  ...
  public TestCaseVersionLinkList startAt(Long startAt) {
  ...
  **/
  ...
  public TestCaseVersionLinkList maxResults(Long maxResults) {
  ...
  **/
  ...
  public TestCaseVersionLinkList total(Long total) {
  ...
  **/
  ...
  public TestCaseVersionLinkList isLast(Boolean isLast) {
  ...
  **/
  ...
  public TestCaseVersionLinkList values(List<TestCaseVersionLink> values) {
    
    this.values = values;
    return this;
  }

  public TestCaseVersionLinkList addValuesItem(TestCaseVersionLink valuesItem) {
    if (this.values == null) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A list of versions for a test case")

  public List<TestCaseVersionLink> getValues() {
    return values;
  }


  public void setValues(List<TestCaseVersionLink> values) {
    this.values = values;
  }
  ...
  public boolean equals(Object o) {
    ...
    TestCaseVersionLinkList testCaseVersionLinkList = (TestCaseVersionLinkList) o;
    return Objects.equals(this.next, testCaseVersionLinkList.next) &&
        Objects.equals(this.startAt, testCaseVersionLinkList.startAt) &&
        Objects.equals(this.maxResults, testCaseVersionLinkList.maxResults) &&
        Objects.equals(this.total, testCaseVersionLinkList.total) &&
        Objects.equals(this.isLast, testCaseVersionLinkList.isLast) &&
        Objects.equals(this.values, testCaseVersionLinkList.values);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestCaseVersionLinkList {\n");

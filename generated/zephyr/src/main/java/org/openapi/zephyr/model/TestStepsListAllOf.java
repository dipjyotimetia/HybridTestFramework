...
public class TestStepsListAllOf {
  public static final String SERIALIZED_NAME_VALUES = "values";
  @SerializedName(SERIALIZED_NAME_VALUES)
  private List<TestStep> values = null;

  public TestStepsListAllOf() { 
  }

  public TestStepsListAllOf values(List<TestStep> values) {
    
    this.values = values;
    return this;
  }

  public TestStepsListAllOf addValuesItem(TestStep valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TestStepsListAllOf testStepsListAllOf = (TestStepsListAllOf) o;
    return Objects.equals(this.values, testStepsListAllOf.values);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestStepsListAllOf {\n");

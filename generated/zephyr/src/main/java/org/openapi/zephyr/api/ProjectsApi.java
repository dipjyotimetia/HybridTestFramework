...
import org.openapi.zephyr.model.ProjectList;
...
public class ProjectsApi {
     ...
     * @param projectIdOrKey The ID or key of the Jira project (required)
     ...
     */
    public okhttp3.Call getProjectCall(String projectIdOrKey, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/projects/{projectIdOrKey}"
    ...
    private okhttp3.Call getProjectValidateBeforeCall(String projectIdOrKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getProjectCall(projectIdOrKey, _callback);
        return localVarCall;
     ...
     */
    public Project getProject(String projectIdOrKey) throws ApiException {
        ApiResponse<Project> localVarResp = getProjectWithHttpInfo(projectIdOrKey);
     ...
     */
    public ApiResponse<Project> getProjectWithHttpInfo(String projectIdOrKey) throws ApiException {
        okhttp3.Call localVarCall = getProjectValidateBeforeCall(projectIdOrKey, null);
     ...
     */
    public okhttp3.Call getProjectAsync(String projectIdOrKey, final ApiCallback<Project> _callback) throws ApiException {

        okhttp3.Call localVarCall = getProjectValidateBeforeCall(projectIdOrKey, _callback);
        Type localVarReturnType = new TypeToken<Project>(){}.getType();
     ...
     */
    public okhttp3.Call listProjectsCall(Long maxResults, Long startAt, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listProjectsValidateBeforeCall(Long maxResults, Long startAt, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = listProjectsCall(maxResults, startAt, _callback);
        return localVarCall;
     ...
     */
    public ProjectList listProjects(Long maxResults, Long startAt) throws ApiException {
        ApiResponse<ProjectList> localVarResp = listProjectsWithHttpInfo(maxResults, startAt);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ProjectList> listProjectsWithHttpInfo(Long maxResults, Long startAt) throws ApiException {
        okhttp3.Call localVarCall = listProjectsValidateBeforeCall(maxResults, startAt, null);
     ...
     */
    public okhttp3.Call listProjectsAsync(Long maxResults, Long startAt, final ApiCallback<ProjectList> _callback) throws ApiException {

        okhttp3.Call localVarCall = listProjectsValidateBeforeCall(maxResults, startAt, _callback);
        Type localVarReturnType = new TypeToken<ProjectList>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }

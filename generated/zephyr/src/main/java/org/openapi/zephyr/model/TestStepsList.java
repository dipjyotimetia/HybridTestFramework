...
import org.openapi.zephyr.model.TestStep;
import org.openapi.zephyr.model.TestStepsListAllOf;

/**
 * Response body when retrieving test steps
 */
@ApiModel(description = "Response body when retrieving test steps")
...
public class TestStepsList {
  ...
  private List<TestStep> values = null;

  public TestStepsList() { 
  }

  public TestStepsList next(String next) {
  ...
  **/
  ...
  public TestStepsList startAt(Long startAt) {
  ...
  **/
  ...
  public TestStepsList maxResults(Long maxResults) {
  ...
  **/
  ...
  public TestStepsList total(Long total) {
  ...
  **/
  ...
  public TestStepsList isLast(Boolean isLast) {
  ...
  **/
  ...
  public TestStepsList values(List<TestStep> values) {
    
    this.values = values;
    return this;
  }

  public TestStepsList addValuesItem(TestStep valuesItem) {
    if (this.values == null) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The list of test steps")

  public List<TestStep> getValues() {
    return values;
  }


  public void setValues(List<TestStep> values) {
    this.values = values;
  }
  ...
  public boolean equals(Object o) {
    ...
    TestStepsList testStepsList = (TestStepsList) o;
    return Objects.equals(this.next, testStepsList.next) &&
        Objects.equals(this.startAt, testStepsList.startAt) &&
        Objects.equals(this.maxResults, testStepsList.maxResults) &&
        Objects.equals(this.total, testStepsList.total) &&
        Objects.equals(this.isLast, testStepsList.isLast) &&
        Objects.equals(this.values, testStepsList.values);
  }

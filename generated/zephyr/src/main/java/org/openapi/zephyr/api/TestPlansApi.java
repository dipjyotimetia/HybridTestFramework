...
import org.openapi.zephyr.model.TestPlanList;
...
public class TestPlansApi {
     ...
     */
    public okhttp3.Call listTestPlansCall(String projectKey, Long maxResults, Long startAt, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call listTestPlansValidateBeforeCall(String projectKey, Long maxResults, Long startAt, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = listTestPlansCall(projectKey, maxResults, startAt, _callback);
        return localVarCall;
     ...
     */
    public TestPlanList listTestPlans(String projectKey, Long maxResults, Long startAt) throws ApiException {
        ApiResponse<TestPlanList> localVarResp = listTestPlansWithHttpInfo(projectKey, maxResults, startAt);
     ...
     * @param maxResults A hint as to the maximum number of results to return in each call. Note that the server reserves the right to impose a maxResults limit that is lower than the value that a client provides, due to lack or resources or any other condition. When this happens, your results will be truncated. Callers should always check the returned maxResults to determine the value that is effectively being used. (optional, default to 10)
     * @param startAt Zero-indexed starting position. Should be a multiple of maxResults. (optional, default to 0)
     * @return ApiResponse&lt;TestPlanList&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<TestPlanList> listTestPlansWithHttpInfo(String projectKey, Long maxResults, Long startAt) throws ApiException {
        okhttp3.Call localVarCall = listTestPlansValidateBeforeCall(projectKey, maxResults, startAt, null);
        Type localVarReturnType = new TypeToken<TestPlanList>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get test plans (asynchronously)
     * Retrieves all test plans. Query parameters can be used to filter the results.
     * @param projectKey Jira project key filter (optional)
     * @param maxResults A hint as to the maximum number of results to return in each call. Note that the server reserves the right to impose a maxResults limit that is lower than the value that a client provides, due to lack or resources or any other condition. When this happens, your results will be truncated. Callers should always check the returned maxResults to determine the value that is effectively being used. (optional, default to 10)
     * @param startAt Zero-indexed starting position. Should be a multiple of maxResults. (optional, default to 0)
     ...
     */
    public okhttp3.Call listTestPlansAsync(String projectKey, Long maxResults, Long startAt, final ApiCallback<TestPlanList> _callback) throws ApiException {

        okhttp3.Call localVarCall = listTestPlansValidateBeforeCall(projectKey, maxResults, startAt, _callback);
        Type localVarReturnType = new TypeToken<TestPlanList>(){}.getType();

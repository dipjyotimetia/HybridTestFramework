...
public class TestCaseListAllOf {
  public static final String SERIALIZED_NAME_VALUES = "values";
  @SerializedName(SERIALIZED_NAME_VALUES)
  private List<TestCase> values = null;

  public TestCaseListAllOf() { 
  }

  public TestCaseListAllOf values(List<TestCase> values) {
    
    this.values = values;
    return this;
  }

  public TestCaseListAllOf addValuesItem(TestCase valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TestCaseListAllOf testCaseListAllOf = (TestCaseListAllOf) o;
    return Objects.equals(this.values, testCaseListAllOf.values);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestCaseListAllOf {\n");

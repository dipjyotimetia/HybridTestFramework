...
public class JiraUserLink {
  ...
  public JiraUserLink accountId(String accountId) {
  ...
  **/
  ...
  @ApiModelProperty(example = "5b10a2844c20165700ede21g", required = true, value = "Atlassian Account ID of the Jira user.")
  ...
  public JiraUserLink self(String self) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    JiraUserLink jiraUserLink = (JiraUserLink) o;
    return Objects.equals(this.accountId, jiraUserLink.accountId) &&
        Objects.equals(this.self, jiraUserLink.self);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accountId, self);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class JiraUserLink {\n");

...
public class TestCycleListAllOf {
  public static final String SERIALIZED_NAME_VALUES = "values";
  @SerializedName(SERIALIZED_NAME_VALUES)
  private List<TestCycle> values = null;

  public TestCycleListAllOf() { 
  }

  public TestCycleListAllOf values(List<TestCycle> values) {
    
    this.values = values;
    return this;
  }

  public TestCycleListAllOf addValuesItem(TestCycle valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TestCycleListAllOf testCycleListAllOf = (TestCycleListAllOf) o;
    return Objects.equals(this.values, testCycleListAllOf.values);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestCycleListAllOf {\n");

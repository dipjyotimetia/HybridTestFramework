...
public class StatusListAllOf {
  public static final String SERIALIZED_NAME_VALUES = "values";
  @SerializedName(SERIALIZED_NAME_VALUES)
  private List<Status> values = null;

  public StatusListAllOf() { 
  }

  public StatusListAllOf values(List<Status> values) {
    
    this.values = values;
    return this;
  }

  public StatusListAllOf addValuesItem(Status valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    StatusListAllOf statusListAllOf = (StatusListAllOf) o;
    return Objects.equals(this.values, statusListAllOf.values);
  }
  ...
  public String toString() {
    ...
    sb.append("class StatusListAllOf {\n");

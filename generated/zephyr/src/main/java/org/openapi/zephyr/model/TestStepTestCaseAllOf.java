...
public class TestStepTestCaseAllOf {
  public static final String SERIALIZED_NAME_TEST_CASE_KEY = "testCaseKey";
  @SerializedName(SERIALIZED_NAME_TEST_CASE_KEY)
  private String testCaseKey;

  public TestStepTestCaseAllOf() { 
  }

  public TestStepTestCaseAllOf testCaseKey(String testCaseKey) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The key of the other test case that the test step should delegate execution to. This cannot be the parent test case.")
  ...
  public boolean equals(Object o) {
    ...
    TestStepTestCaseAllOf testStepTestCaseAllOf = (TestStepTestCaseAllOf) o;
    return Objects.equals(this.testCaseKey, testStepTestCaseAllOf.testCaseKey);
  }

  @Override
  public int hashCode() {
    return Objects.hash(testCaseKey);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TestStepTestCaseAllOf {\n");

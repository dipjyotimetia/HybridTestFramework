...
public class TestExecutionListAllOf {
  public static final String SERIALIZED_NAME_VALUES = "values";
  @SerializedName(SERIALIZED_NAME_VALUES)
  private List<TestExecution> values = null;

  public TestExecutionListAllOf() { 
  }

  public TestExecutionListAllOf values(List<TestExecution> values) {
    
    this.values = values;
    return this;
  }

  public TestExecutionListAllOf addValuesItem(TestExecution valuesItem) {
    if (this.values == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    TestExecutionListAllOf testExecutionListAllOf = (TestExecutionListAllOf) o;
    return Objects.equals(this.values, testExecutionListAllOf.values);
  }
  ...
  public String toString() {
    ...
    sb.append("class TestExecutionListAllOf {\n");

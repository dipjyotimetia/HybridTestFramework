...
public class Defects {
  ...
  public Defects add(List<String> add) {
    
    this.add = add;
    return this;
  }

  public Defects addAddItem(String addItem) {
    if (this.add == null) {
  ...
  **/
  ...
  public Defects remove(List<String> remove) {
    
    this.remove = remove;
    return this;
  }

  public Defects addRemoveItem(String removeItem) {
    if (this.remove == null) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "[\"CALC-3\",\"CALC-4\"]", value = "")
  ...
  public boolean equals(Object o) {
    ...
    Defects defects = (Defects) o;
    return Objects.equals(this.add, defects.add) &&
        Objects.equals(this.remove, defects.remove);
  }
